...
const destinationGuides = {
  ...
  "广州": {intro:"建议先留 2–3 天：老城建筑、早茶与珠江夜景。", foods:[
    ...
    ["艇仔粥与糖水","荔湾一带逛吃时可以留意，粥作正餐、糖水留到饭后。"]
  ]},
  ...
  "汕头": {intro:"建议市区 2 天；如去南澳，再单独留 1 天。不要把海岛和老城塞进一个下午。", foods:[
    ["牛肉火锅与牛肉丸","两个人少量多样点肉，搭配牛肉丸；按店内提示充分煮熟。"],
    ["蚝烙","牡蛎煎制小吃，建议两人分一份，趁热吃。"],
    ["粿条与肠粉","适合早餐或简单正餐，给下一顿留点余量。"],
    ["卤鹅与甘草水果","卤鹅点小份拼盘，水果可作为逛街间的小食。"]
  ]}
};
const extraPlaces = [
  ["gz-chen","广州","陈家祠","人文","荔湾",23.1294,113.2403,"1–2 小时","白天","看岭南建筑、木雕与陶塑细节。","建议先看屋脊装饰，再慢慢走庭院和展厅。可与荔湾老城安排在同一天。","https://en.wikipedia.org/wiki/Chen_Clan_Ancestral_Hall"],
  ["gz-shamian","广州","沙面","人文","荔湾",23.1091,113.2385,"1–2 小时","上午或傍晚","树荫下看历史建筑，沿江慢慢散步。","适合轻松步行和拍建筑。可接荔湾片区觅食，不必专门安排整天。","https://en.wikipedia.org/wiki/Shamian"],
  ["gz-tower","广州","广州塔周边","城市","海珠",23.1064,113.3246,"2–3 小时","傍晚到入夜","在珠江边看城市天际线，不登塔也能赏夜景。","先沿江散步，再决定是否购买登塔或游船项目；收费项目另行核对预约与票价。","https://gochinafreely.com/"],
  ...
  ["st-park","汕头","小公园开埠区","人文","金平",23.3533,116.6744,"半天","下午到入夜","围绕骑楼老街散步，穿插潮汕小吃。","以中山纪念亭周边为步行起点，慢慢走支路。建议一顿正餐加两三样小吃，避免一路吃撑。","https://www.topchinatravel.com/"],
  ["st-mayu","汕头","妈屿岛","海边","龙湖",23.3318,116.7577,"2–3 小时","下午","小岛、海风和村落，适合半天放空。","建议与市区行程错开用餐高峰，提前确认往返交通。与南澳相比，更适合短时海边散步。","https://www.klook.com/"],
  ["st-nanao","汕头","南澳岛·青澳湾","海边","南澳",23.4380,117.1230,"1 天","白天","留一天给海湾和海岛风景。","地图标记位于青澳湾，不代表整个岛。岛上各景点分散，应单独规划交通；出发前看天气与交通公告。","https://www.travelchinaguide.com/"]
